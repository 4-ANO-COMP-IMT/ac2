  ...
  return (
    <main className="flex items-center justify-center overflow-x-hidden py-28">
      ...
      >
        ...
        <div className="h-[320px] w-[320px] animate-one rounded-full  bg-blue-500 opacity-50 blur-[7rem]"></div>
        <div className="h-[320px] w-[320px] animate-two rounded-full  bg-blue-300 opacity-50 blur-[7rem]"></div>
        <div className="h-[320px] w-[320px] animate-two self-start justify-self-start rounded-full  bg-blue-600 opacity-50 blur-[7rem]"></div>
      </div>
      <div
