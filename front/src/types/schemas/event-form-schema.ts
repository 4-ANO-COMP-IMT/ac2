...
export const formSchema = z
  .object({
    ...
    notEarlier: z.string().regex(/^(2[0-3]|1[0-9]|[0-9])$/, {
      message: 'O horário deve ser entre 0 e 22'
    }),
    notLater: z.string().regex(/^(2[0-3]|1[0-9]|[0-9])$/, {
      message: 'O horário deve ser entre 1 e 23'
    }),
  ...
  .refine((data) => parseInt(data.notEarlier) < parseInt(data.notLater), {
    message: 'Horário de trabalho inválido',
    path: ['notEarlier'] // especifica onde o erro será exibido
  })
