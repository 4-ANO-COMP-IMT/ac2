...
export function AnimatedBalls() {
  ...
  return (
    <div
      className={`absolute inset-0 z-0 grid h-full w-full grid-cols-2 justify-items-center gap-4 overflow-hidden transition-all duration-1000 ${fade ? 'opacity-100' : 'opacity-0'}`}
    >
