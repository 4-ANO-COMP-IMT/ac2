...
export function Navbar() {
  ...
  return (
    <nav className="fixed left-0 top-0 flex w-full select-none items-center justify-between border-b-[1px] border-gray-300 px-8 py-3 font-geist text-[15px] sm:px-16">
        ...
        <>
          ...
          >
            <div className="flex items-center justify-between gap-8">
              <h1 className="text-2xl font-bold text-primary">BoraMarcar</h1>
              <IoClose
            ...
            <div className="flex flex-col gap-4">
              <a
                href="/"
                className="text-xl font-light text-secondary transition-all duration-200 hover:text-primary"
              >
                Home
              </a>
              <a
